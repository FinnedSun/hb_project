...
function upd_general(site_title_val, site_about_val) {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      alert('success', 'Simpan perubahan!')
      get_general()
    } else {
      alert('error', 'Gagal di simpan.')
    }
  }
...
function upd_shutdown(val) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1 && general_data.shutdown == 0) {
      alert('success', 'Site telah di matikan!')
    } else {
...
function add_member() {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 'inv_img') {
      ...
      alert('success', 'Member baru telah di tambahkan!')

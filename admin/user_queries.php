          ...
          <div class="card border-0 shadow-sm mb-4" style="margin-top: 100px;">
            <div class="card-body shadow-sm" >
              ...
              <div class="d-flex mb-3 justify-content-between">
                <a href="?seen=all" class="btn btn-dark rounded-pill shadow btn-sm"><i class="bi bi-bookmarks-fill"></i> Baca semua</a>
                <a href="?del=all" class="btn btn-danger rounded-pill shadow btn-sm"><i class="bi bi-trash3-fill"></i> Hapus semua</a>
              </div>

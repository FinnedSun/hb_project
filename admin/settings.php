        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
              ...
              <form id="general_s_form">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" onclick="site_title.value = general_data.site_title, site_about.value = general_data.site_about" class="btn text-secondary" data-bs-dismiss="modal">Batal</button>
          ...
          <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
              ...
              <p class="card-text">Tidak ada pelanggan yang diperbolehkan memesan kamar hotel, ketika shutdown diaktifkan.</p>
            </div>
          </div>
            ...
            <div class="modal-dialog modal-lg">
              <form id="contacts_s_form">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" onclick="contacts_inp(contacts_data)" class="btn text-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn costom-bg text-white">Simpan</button>
                  </div>
                </div>
              </form>
            ...
            <div class="modal-dialog">
              <form id="team_s_form">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" onclick="member_name_inp.value = '', member_picture_inp.value = ''" class="btn text-secondary" data-bs-dismiss="modal">Batal</button>

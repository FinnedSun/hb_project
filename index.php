    ...
    <div class="container-fluid px-lg-4 mt-4">
      <div class="swiper swiper-container">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <img
              src="images/carousel/IMG_55677.png"
              class="w-100 d-block"
              alt=""
            />
          </div>
          ...
          <div class="swiper-slide">
            <img
              src="images/carousel/IMG_93127.png"
              class="w-100 d-block"
              alt=""
            />
          </div>
          ...
          <form>
            <div class="row align-items-end">
              ...
              <div class="col-lg-1 mb-lg-4 mt-2">
                <button
                  type="submit"
                  class="btn text-white shadow-none costom-bg"
                >
                  Submit
                </button>
              </div>
        ...
        <?php
            ...
            while($room_data = mysqli_fetch_assoc($room_res)){
              ...
              if(!$settings_r['shutdown'])
              {
                ...
                $book_btn ="<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm text-white costom-bg shadow-none'>Book Now</button>";
              }
                ...
                <div class="col-lg-4 col-md-6 my-3">
                  ...
                  >
                    ...
                    <div class="card-body">
                      ...
                      <h6 class="mb-4">$room_data[price].000 RP per night</h6>
          ...
          while($row = mysqli_fetch_assoc($res))
          {
            echo <<<data
              <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                ...
                <h5 class="mt-3 text-capitalize">$row[name]</h5>
              </div>
            data;
          }
        ?>

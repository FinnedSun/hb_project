  ...
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="index.php" class="d-inline-block mb-2 text-dark text-decoration-none">
        Home </a><br />
      <a href="ruangan.php" class="d-inline-block mb-2 text-dark text-decoration-none">
        Product </a><br />
      <a href="kontak.php" class="d-inline-block mb-2 text-dark text-decoration-none">
        Kontak kami </a><br />
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block mb-3 text-decoration-none text-dark mb-2">
        <i class="bi bi-facebook me-1"> Facebook</i> </a><br />
      <a href="<?php echo $contact_r['ig'] ?>" class="d-inline-block mb-3 text-decoration-none text-dark">
        <i class="bi bi-instagram me-1"> instagram</i> </a><br />
    </div>
  </div>
</div>
...
<script>
  ...
  function checkLoginToBook(status, room_id) {
    if (status) {
      ...
      alert('error', 'login sebelum membali product')
    }
  }
